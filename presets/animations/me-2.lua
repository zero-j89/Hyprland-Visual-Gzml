...
hl.animation({ leaf = "workspacesIn",     enabled = true, speed = 3.25, bezier = "easeOutQuint", style = "slide" })
hl.animation({ leaf = "workspacesOut",    enabled = true, speed = 3.25, bezier = "easeOutQuint", style = "slide" })
