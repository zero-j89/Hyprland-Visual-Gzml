    ...
    def ensure_generated_config_files(self):
        ...
        if not GZML_ANIMATION_FILE.exists():
            GZML_ANIMATION_FILE.write_text(
                ...
                '-- Include this once from your Hyprland Lua config after your normal animations load:\n'
...
-- Include this once from your Hyprland Lua config after your normal decorations load:
