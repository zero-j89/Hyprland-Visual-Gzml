    ...
    def ensure_generated_config_files(self):
        ...
        if not GZML_ANIMATION_FILE.exists():
            GZML_ANIMATION_FILE.write_text(
                ...
                '-- Include this at the end of your animations.lua config at the very end\n'
...
-- Include this at the end fo your Hyprland Lua config after your normal decorations..
